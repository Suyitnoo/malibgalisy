...
import { Loader2, MapPin, Moon, BookOpen, Crown, MoreHorizontal, MessageSquare, ChevronRight, Share2, Copy, Compass } from "lucide-react";
...
export default function MuslimProDashboard() {
    ...
    */
    ...
    const features = [
        { name: "Qur'an", icon: BookOpen, href: "/quran" },
        { name: "Doa", icon: MessageSquare, href: "/dua" },
        { name: "Tasbih", icon: MoreHorizontal, href: "/tasbih" },
        { name: "Qiblat", icon: Compass, href: "/qibla" },
            ...
            <div className="relative bg-gradient-to-br from-[#4c1d95] via-[#6d28d9] to-[#8b5cf6] text-white rounded-b-[40px] shadow-xl overflow-hidden pt-12 pb-8 px-6 mb-6">
                ...
                <div className="relative z-10 text-center mb-8">
                    <p className="text-sm font-medium text-violet-100 mb-1">
                        {nextPrayer?.name === 'Imsak' ? 'Sehri Time' : 'Upcoming Prayer'}
                    </p>
