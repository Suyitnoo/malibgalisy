...
export default function ProfilePage() {
    ...
    const weeklyProgress = [
        ...
        { day: "Fri", value: 75 },
        { day: "Sat", value: 85 },
        { day: "Sun", value: worshipStats.today },
    ];
                ...
                <div className="grid grid-cols-2 gap-4">
                    <Card className="border-slate-100 shadow-sm">
                        <CardContent className="p-5 flex flex-col items-center justify-center text-center">
                            <div className="h-10 w-10 mb-2 rounded-full flex items-center justify-center bg-violet-50 text-violet-600">
                    ...
                    <Card className="border-slate-100 shadow-sm">
                        <CardContent className="p-5 flex flex-col items-center justify-center text-center">
                            <div className="h-10 w-10 mb-2 rounded-full flex items-center justify-center bg-emerald-50 text-emerald-600">
