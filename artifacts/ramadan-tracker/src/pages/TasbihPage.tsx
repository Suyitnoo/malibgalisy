        ...
        <main className="min-h-screen bg-slate-50 text-slate-800 flex flex-col items-center justify-between pb-10 relative overflow-hidden">
            <div className="w-full bg-white/80 backdrop-blur-md sticky top-0 z-30 shadow-sm border-b border-slate-100">
                <div className="max-w-md mx-auto px-6 py-4 flex items-center justify-between">
                    <Button variant="ghost" size="icon" onClick={() => navigate("~/")} className="rounded-full hover:bg-slate-100 -ml-2">
            ...
            <div className="flex-1 flex flex-col items-center justify-center w-full max-w-md relative pt-6">
                ...
                <div className="flex gap-6 items-center">
                    <Button variant="outline" size="icon" className="h-12 w-12 rounded-full border-slate-200 text-slate-500 hover:text-violet-600 hover:bg-violet-50" onClick={resetCount}>
                        <RotateCcw className="w-5 h-5" />
                    </Button>

                    <Button className="h-12 px-6 rounded-full bg-slate-900 text-white hover:bg-slate-800 font-bold" onClick={handleTap}>
                        Tap to Count
                    </Button>

                    <Button variant="outline" size="icon" className="h-12 w-12 rounded-full border-slate-200 text-slate-500 hover:text-violet-600 hover:bg-violet-50 relative" onClick={changeTarget}>
